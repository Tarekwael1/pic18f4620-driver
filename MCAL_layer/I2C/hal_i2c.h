...
/* SSP Receive Overflow Indicator  */
#define I2C_OVERFLOW_INDICATOR()            (SSPCON1bits.SSPOV = 1)
#define I2C_NO_OVERFLOW_INDICATOR()         (SSPCON1bits.SSPOV = 0)

/* SSP Write Collision Detect */
#define I2C_COLLISION_DETECT()              (SSPCON1bits.WCOL = 1)
#define I2C_NO_COLLISION_DETECT()           (SSPCON1bits.WCOL = 0)

/* I2C Send Acknowledge */
#define I2C_SEND_ACKNOWLEDGE()              (SSPCON2bits.ACKDT = 0)
#define I2C_SEND_NOT_ACKNOWLEDGE()          (SSPCON2bits.ACKDT = 1)

/* I2C Acknowledge Sequence Enable */
#define I2C_ACKNOWLEDGE_SEQUENCE_ENABLE()   (SSPCON2bits.ACKEN = 1)
